import './AboutTime.css';
import { Card, Col, Container, Row } from 'react-bootstrap';
import time01 from '../../assets/images/About-Time-section/member-model.webp';
...
>
        <div className='about-time pb-4'><h2>Our Team Member</h2></div>

        <div className='about-card'>
            <Row>

                <Col lg={3} md={4} sm={12} className='p-1'>
                    <Card>
                        ...
                        <div className="card-icons">
                            <ul className='d-flex pt-3 listSocial'>
                                <li>
                                    <a href='#facebook'>
                                        <svg xmlns="http://www.w3.org/2000/svg" height="22" width="22" viewBox="0 0 320 512">
